...
# You have three pathes to choose from:
# Hard: write everything from scratch including tests
# Medium: pull the tests write the two classes yourself
# Easy: use the template classes in easy_warmup-006.rb to solve the problem


# Even if you choose the easy challenge, take a bit to think about the fundamentals of your
# dice throwing app.
# What classes do we need? What is their relation to each other? How do they interact with each other?
...
# To summarize the app functionality, we want to have for example:
